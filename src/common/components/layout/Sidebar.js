    ...
    return (
    	...
    	<div className="sidebar">
		  ...
		  <div className="sidebar-item sidebar-footer">
		    <p>I built this site with Redux and React.</p>
		  </div>
		  ...
		  <div className="sidebar-item sidebar-footer">
		    ...
		    <p>
				Visit <a href="https://github.com/msegu009">My GitHub Repo</a><br/>
				Visit <a href="https://www.linkedin.com/in/michael-segura">My Linkedin</a><br/>
		    </p>
